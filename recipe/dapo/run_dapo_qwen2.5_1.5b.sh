...
set -xeuo pipefail
project_name='RLVR'
exp_name='DAPO-Qwen2.5-1.5B-GSM8K-nofilter-vtp1tmp0'
...
ADAPTER_PATH=${ADAPTER_PATH:-"${HOME}/verl/ckpts/RLVR/DAPO-Qwen2.5-1.5B-GSM8K-V2/global_step_115/actor/lora_adapter"}
